...
class Shcool_Manager:
    ...
    def menu_shcool(self):
        while True:
            ...
            print('------------------------------------')
            print('-          НОМЕР ШКОЛЫ             -')
            print('-           нажмите "1"            -') # print('-           нажмите "2"            -')
    ...
    def add_student(self):
        sh = self.shcool
        first_name_student = valid_symbol("введите имя ученика (с заглавной буквы): ")
        last_name_student = valid_symbol("введите фамилию ученика(с заглавной буквы): ")
        age_student = valid_digit("введите возраст ученика (от 6 до 19): ", 6, 19)
        number_class = valid_digit("введите класс ученика (от 1 до 11): ", 1, 11)
